...
**Problem:** API endpoints change, but Swagger/OpenAPI docs are manually updated and drift out of sync.

**Solution:** Generate API documentation from code comments and route definitions.
...
**How it works:**
1. Triggers when API code is pushed to main
2. Scans route definitions and extracts metadata
3. Updates OpenAPI spec and Markdown docs
4. Opens PR for review

**Advanced:**
- Validate request/response against TypeScript types
- Auto-publish docs to GitHub Pages
- Generate client SDKs from updated spec
---
